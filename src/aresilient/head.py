r"""Contains synchronous HTTP HEAD request with automatic retry logic."""
...
def head(
    ...
    **kwargs: Any,
    ...
    This function performs an HTTP HEAD request with a configured retry
    ...
    Example:
        ...
        >>> response = head("https://api.example.com/data", config=config)  # doctest: +SKIP
