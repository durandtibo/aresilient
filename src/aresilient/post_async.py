r"""Contains asynchronous HTTP POST request with automatic retry
logic."""
...
async def post_async(
    ...
    **kwargs: Any,
    ...
    This function performs an HTTP POST request with a configured retry
    ...
    Example:
        ...
        >>> async def example():
        ...     response = await post_async("https://api.example.com/data", config=config)
