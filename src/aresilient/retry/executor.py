r"""Synchronous retry executor for HTTP requests.

This module provides the RetryExecutor class that executes HTTP requests
with automatic retry logic and circuit breaker integration.
"""
