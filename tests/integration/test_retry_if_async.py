...
@pytest.mark.asyncio
async def test_retry_if_with_response_content_check() -> None:
    ...
    mock_client.get = Mock(side_effect=_mock)
...
@pytest.mark.asyncio
async def test_retry_if_with_custom_status_logic() -> None:
    ...
    responses = [mock_response_429, mock_response_500, mock_response_ok]
    call_count = 0
...
@pytest.mark.asyncio
async def test_retry_if_with_exception_handling() -> None:
...
@pytest.mark.asyncio
async def test_retry_if_exhausts_retries() -> None:
...
@pytest.mark.asyncio
async def test_retry_if_does_not_retry() -> None:
...
@pytest.mark.asyncio
async def test_retry_if_with_complex_business_logic() -> None:
...
@pytest.mark.asyncio
async def test_retry_if_with_callbacks() -> None:
