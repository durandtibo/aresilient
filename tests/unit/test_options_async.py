...
This file contains tests that are specific to the async OPTIONS HTTP
...
The core async tests cover all the retry logic and error handling.
Currently, there are no OPTIONS-specific tests needed beyond what's in
test_core_async.py.
"""
