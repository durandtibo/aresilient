...
This file contains tests that are specific to the async HEAD HTTP
...
don't return a response body. The core async tests cover all the retry
logic and error handling. Currently, there are no HEAD-specific tests
needed beyond what's in test_core_async.py.
"""
